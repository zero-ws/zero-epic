...
import io.horizon.exception.internal.InvokingSpecException;
...
final class HInvoke {
    ...
    static <T> T invokeStatic(
        ...
        return (T) HFn.failOr(null, () -> invoker.invoke(null, args));
    }
    ...
    private static Method methodSeek(final Object instance, final String name, final Object... args) {
        ...
        if (TIs.isNil(name) || Objects.isNull(instance)) {
            throw new _412ArgumentNullException(HInvoke.class, "name | instance");
        }
    ...
    static <T> T invokeObject(
        ...
        if (Objects.isNull(method)) {
            throw new _412ArgumentNullException(HInvoke.class, "method: " + name + " is null");
        }
        ...
        try {
            ...
            if (void.class == returnType) {
                ...
                HFn.out(method.getParameters().length != args.length + 1,
                    InvokingSpecException.class, HInvoke.class, method);
                /*
